...
test.describe("Backspace with hidden deletions", () => {
  ...
  test.describe("Backspace in a paragraph", () => {
    test("Fails to delete multiple characters with Backspace one after another, but skips over the hidden deletion", async ({
      ...
      // correct position should be 28 after two Backspace presses, but it is 29
      ...
      // correct start position of the deletion mark should be 28 after two Backspace presses, but it is 29
      ...
      // it skips over the hidden deletion
